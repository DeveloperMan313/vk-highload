...
* Ключ найден:
Получить set из строк вида с shard_id, запросить из всех указанных шардов ответы по индексированному FK question_id, вернуть пользователю.
* Ключ не найден:
...
В метрике схожести вопросов учитывается:
TODO

### Сводная таблица алгоритмов

| Алгоритс | Область применения | Мотивационная часть |
|----------|--------------------|---------------------|
