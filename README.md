...
Количество шардов рассчитано для одного ДЦ США (т.е. 0.11 от всего объема данных).
...
|----------|--------------------|---------------------|
| **PageRank** | Ранжирование ответов | Определение авторитетности пользователей на основе графа подписок и качества ответов |
| **Collaborative Filtering** | Рекомендации вопросов | Предсказание интересов пользователей на основе поведения похожих пользователей |
...
| **LWW (Last Write Wins)** | Синхронизация голосов | Разрешение конфликтов по временным меткам в Cassandra, последняя запись побеждает |
...
### Моменты обновления денормализованных полей

| Таблица | Денормализованное поле | Момент обновления |
|---------|------------------------|-------------------|
| **answer** | vote_count | При добавлении/удалении голоса в таблице answer_vote |
| **answer** | vote_score | При добавлении/удалении голоса в таблице answer_vote |
| **user** | followers_count | При добавлении/удалении подписки в таблице user_sub_user |
| **user** | following_count | При добавлении/удалении подписки в таблице user_sub_user |
| **user** | answers_count | При создании/удалении ответа в таблице answer |
| **user** | questions_count | При создании/удалении вопроса в таблице question |
| **topic** | followers_count | При добавлении/удалении подписки в таблице user_sub_topic |
| **topic** | questions_count | При создании/удалении связи вопроса с темой в таблице question_topic |
