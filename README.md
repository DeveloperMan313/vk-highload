...
| **question** | Composite Hash | hash(question_id + topic_id) | 4 | Master-Slave (2 реплики) |
...
| **answer** | Composite Hash | hash(user_id + question_id) | 16 | Master-Slave (2 реплики) |
| **answer_vote** | Composite Hash | hash(user_id + answer_id) | 8 | Neo4j Causal Cluster |
...
| Отозванные токены и ленты рекомендаций | Hash | CRC16(key) % 16384 | 3 | Master-Slave (2 реплики) |
