...
| pfp_url | TEXT | 500 | URL аватара |
| created_at | TIMESTAMP | 8 | |
| updated_at | TIMESTAMP | 8 | |
| **Итого на строку** | | **~3389** | |

**Всего строк:** 430M × **~1.46 TB**
...
| user_id | INTEGER | 4 | |
| title | TEXT | 500 | |
| url_title | TEXT | 500 | Unique |
| contents | TEXT | 75 | |
| created_at | TIMESTAMP | 8 | |
| updated_at | TIMESTAMP | 8 | |
| **Итого на строку** | | **~1099** | |

**Всего строк:** 5.84M × **~6.42 GB**
...
**Всего строк:** 5.84M × 3 (avg topics per question) × **~140.2 MB**
...
**Всего строк:** 29.2M × 10 (avg votes per answer) × **~6.13 GB**
...
**Всего строк:** 430M × 10 (avg subscriptions) × **~34.4 GB**
...
**Всего строк:** 430M × 5 (avg topic subs) × **~17.2 GB**
...
| **question** | Создание вопросов | 0.05 | 1470 | 1470.05 | Доминирует чтение |
| **topic** | Создание тем | 0.01 | 313 | 313.01 | В основном чтение |
| **question_topic** | Связи вопрос-тема | 0.15 | 1470 | 1470.15 | Высокая читаемость |
| **answer** | Создание ответов | 24 | 1470 | 1494 | Баланс чтения/записи |
| **answer_vote** | Голосование | 74 | 147 | 221 | Частые обновления |
