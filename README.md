...
| **Images** | Проверяет и сжимает изображения. Добавляет URL в Redis перед тем, как Write сервис запишет их вместе с answer в Postgres | Проверяет авторизацию в Auth сервисе, загружает изображения в кластер Minio |
...
| **Auth** | 385 RPS | 4000m | 6000m | 4 Gi | 4 Gi | 20 |
...
RPS Auth сервиса включает в себя сумму RPS всех сервисов, использующих его.
